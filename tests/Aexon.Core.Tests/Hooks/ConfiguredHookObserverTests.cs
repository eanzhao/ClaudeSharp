...
""");
    ...
    public async Task NonBlockingEvents_ForwardContextMetadataAndPayloadShape()
    {
        ...
        await observer.OnSessionStartAsync(new SessionHookContext(
            ...
            "/work",
            "claude-sonnet-4-6",
            new Aexon.Core.Storage.ConversationSessionMetadata(),
            9));
        ...
        await observer.OnPostCompactAsync(new CompactHookContext(
            ...
            {
                SummaryMessage = new Aexon.Core.Messages.UserMessage
                {
                    IsMeta = true,
                    Content = [new Aexon.Core.Messages.TextBlock("summary")],
                },
                ActiveMessages = [],
        ...
        await observer.OnStopAsync(new StopHookContext(
            ...
            4,
            new Aexon.Core.Messages.TokenUsage
            {
                InputTokens = 1,
                OutputTokens = 2,
        ...
        await observer.OnStopFailureAsync(new StopHookContext(
            ...
            5,
            Aexon.Core.Messages.TokenUsage.Empty));
